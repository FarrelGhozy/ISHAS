...
## 0. Pemeriksaan rencana — Stage 00, tanpa kode
...
- Periksa perubahan hanya di `docs/`; file pengguna yang sudah berubah sebelumnya tetap utuh.
- Catat keputusan terbuka sebagai belum selesai; jangan menandai lulus produk atau selesai diskusi.
- Lint/typecheck/test/build dan browser tidak diperlukan untuk revisi Markdown ini; bukan bukti sudah bekerja.
...
catat `BELUM DIUJI — menunggu -XX`, lalu periksa saat dependensinya tersedia.
...
| U-16 | Reset ISHAS ketika data demo lama pernah ada di perangkat | Namespace/data yang disentuh persis data ; seluruh relasi seed konsisten |
