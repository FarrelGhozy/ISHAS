# Masukan Tambahan (Opsional, Di Luar Permintaan)
...
## 7. Penamaan key penyimpanan demo (disarankan)
...
- Alasan: memisahkan namespace key sesi/draft dari key domain agar tidak tercampur. Kebijakan akhir (reset/hapus key lama) tetap mengikuti D-01.
