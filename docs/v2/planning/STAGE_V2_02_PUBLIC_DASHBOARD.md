...
**Dependensi:** V2-01 `REVIEW` (fondasi tersedia; persetujuan formal menyusul sesuai aturan §3).
...
Route (12/#): #1–2 lulus — `/` tanpa login memuat dashboard + pemilih; isi `/` SAMA saat login
  ...
  empty state tanpa crash. Baris 3–12: BELUM DIUJI — menunggu V2-03/04/05/08/09.
Guard/sesi: lulus (sesi menunjuk ID akun, perbaikan shell publik; guard penuh tercakup V2-01).
Skenario E2E (1-8): BELUM DIUJI — menunggu V2-03/05 (form lapor + antrean validasi).
