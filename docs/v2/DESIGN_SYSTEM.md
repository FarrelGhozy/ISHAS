# V2 — Sistem Desain (Disalin Persis dari V1 + Tambahan Baru)

> Aturan: seluruh hex di bawah disalin dari `apps/web/app/globals.css` V1. Implementasi V2 WAJIB memakai nilai ini. Dilarang menggeser marun ke merah terang/oranye/biru sebagai warna identitas.

**Catatan validasi rencana:** token ini adalah acuan visual V1. Pemilik masih membahas V2;
detail layout, ukuran teks, dan copy belum disetujui ulang (D-12). Pemeriksaan dokumentasi
bukan bukti bahwa tampilan V2 atau aksesibilitasnya sudah lulus pengujian.

## 1. Token warna (hex persis V1)
...
## 2. Pemetaan status V2 → kelas + ikon + label (rancangan untuk review)
...
## 3. Komponen (gaya V1, dipakai ulang tanpa redesign)
...
2. Periksa kontras setiap pasangan teks/latar pada ukuran aktual saat review tampilan; jangan menganggap seluruh kombinasi otomatis lulus karena berasal dari V1. Ukuran badge 8px dan label/tombol 10–11px pada salinan lama perlu pemeriksaan keterbacaan bersama D-12.
...
## 5. Yang BOLEH ditambah di V2 (di luar salinan V1)
