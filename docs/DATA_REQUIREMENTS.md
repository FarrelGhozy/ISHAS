# Detail Kebutuhan Data untuk Review
...
Pada lama, `reports` sudah digunakan untuk daftar laporan ringkasan di store. Menggantinya dengan
...
- Reset menghasilkan hubungan ID konsisten, membersihkan data yang ditetapkan, serta tidak
